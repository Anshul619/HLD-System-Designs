...
- ECR is integrated with [ECS](../2_ComputeServices) & [EKS](AmazonEKS.md), simplifying our development to production workflow.
...
- And then it can be accessed through ARN. (by [ECS](../2_ComputeServices), [EKS](AmazonEKS.md) or On-Perm)
