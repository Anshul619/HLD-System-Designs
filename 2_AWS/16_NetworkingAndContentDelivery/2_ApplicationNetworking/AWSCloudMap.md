# AWS Cloud Map
- [AWS Cloud Map](https://aws.amazon.com/cloud-map/) is a [cloud resource discovery service](../../../5_MicroServices/2_ServiceRegistry&Discovery/Readme.md). 
...
- This increases your application availability because [your web service](../../../5_MicroServices/Readme.md) always discovers the most up-to-date locations of its resources.
- Cloud Map allows you to register any application resources, such as databases, queues, [microservices](../../../5_MicroServices/Readme.md), and other cloud resources, with custom names.
...
- There is no special proxy like [load balancer](ElasticLoadBalancer/Readme.md) in between [two microservices](../../../5_MicroServices/Readme.md), so no additional network hop which means very good performance improvement using [Service Discovery](../../../5_MicroServices/2_ServiceRegistry&Discovery/Readme.md).
