...
- AZs give customers the ability to operate production applications and databases that are more [highly available](../7a_HighAvailability/Readme.md), [fault-tolerant](../7a_HighAvailability/FaultTolerance.md), and [scalable](../3_Databases/3_ScalabilityTechniques/Readme.md) than would be possible from a single data center.
...
# Points of Presence
- [POPs](https://www.medianova.com/en-blog/what-is-a-pop-and-how-do-we-create-one/) are used for both [Amazon CloudFront](16_NetworkingAndContentDelivery/1_EdgeNetworking/AmazonCloudFront.md) to deliver content to end users at high speeds, and [Lambda@Edge](2_ComputeServices/AWSLambda/Readme.md) to run Lambda functions with the lowest possible latency. 
