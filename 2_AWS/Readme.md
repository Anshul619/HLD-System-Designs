...
| [Serverless Architecture](2a_ServerlessArchitecture/Readme.md)      | AWS provides easily managed [serverless architecture](2a_ServerlessArchitecture/Readme.md).                                                                                                                                                                                                                                             |
...
- [Dropbox Saves Millions by Building a Scalable Metadata Store on Amazon DynamoDB and Amazon S3](../1_TechStacks/Dropbox/DropboxMetaDataStore.md)
...
<table>
  <tbody>
    ...
    <tr>
        <td>
            <a href="10_BigDataServices/DataProcessing">Big Data Processing</a>
        </td>
        <td>
            <div class="container" style="background:white">
