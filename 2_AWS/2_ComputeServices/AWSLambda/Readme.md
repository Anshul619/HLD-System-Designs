...
| [Test locally using AWS SAM CLI](../../2a_ServerlessArchitecture/SAM.md)                                                                                         | [AWS SAM CLI](../../2a_ServerlessArchitecture/SAM.md) can be used to test the Lambda function locally.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
...
| [Schedule expressions using rate or cron](https://docs.aws.amazon.com/lambda/latest/dg/services-cloudwatchevents-expressions.html)  | AWS Lambda supports standard rate and cron expressions for frequencies of up to once per minute. <br/>- [EventBridge (CloudWatch Events)](../../4_MessageBrokerServices/AmazonEventBridge.md) rate expressions are simpler to define but do not offer the fine-grained schedule control that cron triggers support.                                                                                                                                                                                                                                          |
...
| [AWS KMS key](../../17_SecurityServices/1_DataProtectionServices/AWSKMS.md)         | Environment Variable | -           | -                                                                                                                                                                                     |
