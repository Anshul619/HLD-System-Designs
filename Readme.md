...
- [Key Components of Distributed Systems](0_SystemGlossaries/Readme.md)
...
- [HLD Design Problems](12_HLDDesignProblemsUC)
- [Real-world tech stacks](13_TechStacksRealWorld)
...
<table>
  <tbody>
    <tr>
      <td>
        <a href="2_APITechOptions/README.md">API Tech Options (or CDN)</a>
      </td>
      <td>
...
[//]: # (                </a>)
                <a href="2_APITechOptions/gRPC.md" target="_blank">
                ...
                <a href="2_APITechOptions/GraphQL.md" target="_blank">
                  <img src="https://marmelab.com/images/blog/graphql/logo.png" width="150">
                </a>
                <a href="11_AWSServices/1_NetworkingAndContentDelivery/1_EdgeNetworking/AmazonCloudFront.md" target="_blank">
    ...
    <tr>
      <td>
        <a href="4_MessageBrokers">Message brokers</a>
      </td>
      <td>
        <div class="container" style="background:white">
            <div class="block two first">
                <a href="/4_MessageBrokers/Kafka/Readme.md" target="_blank">
                  <img src="http://i1.wp.com/airisdata.com/wp-content/uploads/2016/01/kafka-logo-600x390.jpg?resize=600%2C390" width="150">
                </a>
                <a href="11_AWSServices/5_MessageBrokerServices/AmazonKinesis/AmazonKinesisDataStreams.md" target="_blank">
                  <img src="https://intellipaat.com/blog/wp-content/uploads/2022/08/image-75.png" width="150">
                </a>
                <a href="11_AWSServices/5_MessageBrokerServices/AmazonSQS/Readme.md" target="_blank"><img src="https://i0.wp.com/blog.knoldus.com/wp-content/uploads/2021/09/sqs.png?w=711&ssl=1" width="150"></a>
                <a href="11_AWSServices/5_MessageBrokerServices/AmazonEventBridge.md" target="_blank"><img src="https://user-images.githubusercontent.com/3268013/149550617-d92fa8ff-f95d-499c-8515-0ed0be976fbf.png" width="150"></a>
                <a href="11_AWSServices/5_MessageBrokerServices/AmazonSNS.md" target="_blank"><img src="https://miro.medium.com/max/720/0*QjKNs9dEShlQ39VI.png" width="150"></a>
                <a href="4_MessageBrokers/RabbitMQ.md" target="_blank"><img src="https://www.logo.wine/a/logo/RabbitMQ/RabbitMQ-Logo.wine.svg" width="150"></a>
                <a href="4_MessageBrokers/ActiveMQ.md" target="_blank"><img src="https://cdn.icon-icons.com/icons2/2699/PNG/512/apache_activemq_logo_icon_168628.png" width="150"></a>
            </div>
        </div>
      </td>
    </tr>
    <tr>
      <td>
        <a href="3_DatabaseServices/Search-Databases" target="_blank">Search Engines</a>
      </td>
      <td>
        <div class="container" style="background:white">
            <div class="block two first">
      ...
      <td>
        <div class="container" style="background:white">
            <div class="block two first">
                ...
                <a href="7_ClusterCoordinationService/etcd.md" target="_blank">
                  <img src="https://cdn.freebiesupply.com/logos/large/2x/etcd-logo-png-transparent.png" width="150">
                </a>
                <a href="7_ClusterCoordinationService/ApacheZookeeper.md" target="_blank">
    ...
    <tr>
      <td>
        <a href="7_ClusterCoordinationService/Readme.md" target="_blank">Cluster Coordination Service & Config store</a>
      </td>
      <td>
        <div class="container" style="background:white">
            <div class="block two first">
    ...
    <tr>
      <td>
        <a href="5_BigDataServices/ETLServices/BatchProcessing/Readme.md">Batch Processing</a>
      </td>
      <td>
        <div class="container" style="background:white">
            <div class="block two first">
                <a href="5_BigDataServices/ETLServices/BatchProcessing/ApacheHadoop/Readme.md" target="_blank">
                  <img src="https://www.clipartmax.com/png/middle/180-1806192_hadoop-apache-hadoop-logo.png" width="150">
                </a>
                <a href="5_BigDataServices/ETLServices/ApacheSpark.md" target="_blank">
    ...
    <tr>
      <td>
        <a href="5_BigDataServices/ETLServices/StreamProcessing/Readme.md">Stream Processing</a>
      </td>
      <td>
        <div class="container" style="background:white">
            <div class="block two first">
                <a href="5_BigDataServices/ETLServices/StreamProcessing/SparkStreaming.md" target="_blank">
                  <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/f/f3/Apache_Spark_logo.svg/1200px-Apache_Spark_logo.svg.png" width="150">
                </a>
                <a href="5_BigDataServices/ETLServices/StreamProcessing/KafkaStreamsAPI.md" target="_blank">
                ...
                <a href="11_AWSServices/10_BigDataServices/ETLServices/StreamProcessing/AmazonKinesisDataFirehouse/Readme.md" target="_blank">
      ...
      <td>
        <div class="container" style="background:white">
            <div class="block two first">
                ...
                <a href="11_AWSServices/6_DatabaseServices/AmazonDynamoDB/Readme.md">
    ...
    <tr>
      <td>
        <a href="9_FileStorage" target="_blank">
      ...
      <td>
        <div class="container" style="background:white">
            <div class="block two first">
                <a href="11_AWSServices/7_StorageServices/3_ObjectStorageS3/Readme.md" target="_blank">
                  <img src="https://miro.medium.com/max/580/1*DHe24MbDHtbkOeIJzxrfdA.png" width="150">
                </a>
                <a href="9_FileStorage/ApacheHDFS.md" target="_blank">
    ...
    <tr>
      <td>
        <a href="8_ObservabilityLogsServices/">Observability & Logging Services</a>
      </td>
      <td>
        <a href="8_ObservabilityLogsServices/NewRelic.md">
          <img src="https://www.vectorlogo.zone/logos/newrelic/newrelic-ar21.svg" width="150">
        </a>
        <a href="8_ObservabilityLogsServices/ELK.md">
          <img src="https://miro.medium.com/max/746/1*DbdVXy9_6uJVe8q1NOYVfg.png" width="150">
        </a>
        <br/><br/>
        <a href="11_AWSServices/8_MonitoringServices/AmazonCloudWatch/Readme.md">
...
- [Observability & Monitoring](8_ObservabilityLogsServices/Readme.md)
