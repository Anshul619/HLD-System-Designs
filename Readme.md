...
<table>
  <tbody>
    ...
    <tr>
      <td>
        <a href="7_PropertiesDistributedSystem/CDNs">CDN</a>
      </td>
      <td>
        <div class="container" style="background:white">
            <div class="block two first">
      ...
      <td>
        <div class="container" style="background:white">
            <div class="block two first">
                ...
                <a href="3_DatabaseServices/10_Document-Databases/MongoDB.md" target="_blank">
    ...
    <tr>
      ...
      <td>
        <div class="container" style="background:white">
            <div class="block two first">
                <a href="6_BigDataServices/DataProcessing/ApacheMapReduce/Readme.md" target="_blank">
                  <img src="https://www.clipartmax.com/png/middle/180-1806192_hadoop-apache-hadoop-logo.png" width="150">
                </a>
                <a href="6_BigDataServices/DataProcessing/ApacheSpark/Readme.md" target="_blank">
                ...
                <a href="6_BigDataServices/DataProcessing/KafkaStreams/Readme.md" target="_blank">
                ...
                <a href="2_AWSServices/10_BigDataServices/DataConnectors/AmazonKinesisDataFirehouse/Readme.md" target="_blank">
    ...
    <tr>
      ...
      <td>
        <a href="12_ObservabilityServices/NewRelic">
