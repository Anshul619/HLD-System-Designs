...
- Leader (master) copy is maintained by [leader-follower (master-slave)](../../Consistency&Replication/Replication.md) and replicated to n other follower (slave) nodes.
