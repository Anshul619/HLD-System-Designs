...
- It was designed to operate with [predictable low latency at high throughput](../../7_PropertiesDistributedSystem/Scalability/Latency.md) with uncompromising reliability, both [high availability](../../7_PropertiesDistributedSystem/Reliability/HighAvailability.md) and [ACID guarantees](../ACIDTransactions/Readme.md).
