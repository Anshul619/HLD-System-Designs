# Apache HBase
- An open source, non-relational, versioned database that runs on top of [Hadoop Distributed File System (HDFS)](../../11_FileStorageServicesHDFS/ApacheHDFS.md) or [Amazon S3](../../2_AWSServices/7_StorageServices/3_ObjectStorageS3/Readme.md) (using [EMRFS](../../2_AWSServices/10_BigDataServices/DataProcessing/BatchProcessing/AmazonEMR.md)). 
