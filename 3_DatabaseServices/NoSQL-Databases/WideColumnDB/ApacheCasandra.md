...
| Feature                                          | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
|--------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| :star: Low-Latency, Faster Writes                | Since writes in Casandra result in storage in an [append-only structure](../../DataStructuresUsedInDB/AppendOnlyProperty.md), writes are generally very fast.<br/>- Casandra provides [low latency](../../../7_PropertiesDistributedSystem/Scalability/LatencyThroughput.md), at the cost of [consistency](../../Consistency&Replication/Readme.md).<br/>- Refer [PACELC theorem](../../CAP&PACELCTheorems/Readme.md) for more info.                                                                                                                                                                                                                      |
