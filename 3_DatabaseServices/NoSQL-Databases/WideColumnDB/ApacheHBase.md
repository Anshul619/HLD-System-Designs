# Apache HBase
- An open source, non-relational, versioned database that runs on top of [Hadoop Distributed File System (HDFS)](../../../9_FileStorage/ApacheHDFS.md) or [Amazon S3](../../../11_AWSServices/7_StorageServices/3_ObjectStorageS3/Readme.md) (using [EMRFS](../../../11_AWSServices/10_BigDataServices/ETLServices/BatchProcessing/AmazonEMR.md)). 
