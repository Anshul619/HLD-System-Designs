...
- It was designed to operate with [predictable low latency at high throughput](../../7_SystemGlossaries/Scalability/LatencyThroughput.md) with uncompromising reliability, both [high availability](../../7_SystemGlossaries/Reliability/HighAvailability.md) and [ACID guarantees](../Glossaries/ACIDTransactions/Readme.md).
