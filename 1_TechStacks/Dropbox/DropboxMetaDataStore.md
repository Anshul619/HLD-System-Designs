...
- The Alki team is now exploring how it might use [Amazon EMR](../../2_AWSServices/10_BigDataServices/DataProcessing/BatchProcessing/AmazonEMR.md) to **more efficiently offload the data from Amazon DynamoDB to Amazon S3**, a process that is currently handled by Dropbox’s own batch processing system. 
