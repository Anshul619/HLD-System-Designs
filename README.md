...
| [DynomoDB](src/DesignComponents/AWS/DatabaseServices/DynamoDB.md)         | Predictable performance and cost        | NoSQL DB as a Service ( AWS )  | More than 20 million requests per second          | less than 10-20 ms | No  |
...
Component Type | `Open Source` ( [Amazon MSK](https://aws.amazon.com/msk/) on AWS )                    | `Open Source` ( [Amazon MQ](src/DesignComponents/AWS/MessageBrokerServices/AmazonMQ.md) on AWS )                                                                                         | `AWS Managed Service`                                              | `AWS Managed Service`                                                                                                                                                             | `Open Source` ( [Amazon MQ](src/DesignComponents/AWS/MessageBrokerServices/AmazonMQ.md) on AWS ) |
