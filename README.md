...
Basis                                 | [Kafka](src/DesignComponents/MessageBrokers/Kafka.md)                                 | [RabbitMQ](src/DesignComponents/MessageBrokers/RabbitMQ.md)                                                                                                        | [Amazon SQS](src/DesignComponents/AWS/MessageBrokers/AmazonSQS.md)                | [Amazon SNS](src/DesignComponents/AWS/MessageBrokers/AmazonSNS.md)                                                                                                                               | [Active MQ](src/DesignComponents/MessageBrokers/ActiveMQ.md)               |
---------------------------------------|---------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------|
Strength | High-Throughput Broker                                                                | Low-Latency MQ                                                                                                                                                     | -                                                                  | -                                                                                                                                                                                 | Enterprise-Based MQ                                                        ||
...
Component Type | `Open Source` ( [Amazon MSK](https://aws.amazon.com/msk/) on AWS )                    | `Open Source` ( [Amazon MQ](src/DesignComponents/AWS/MessageBrokers/AmazonMQ.md) on AWS )                                                                                         | `AWS Managed Service`                                              | `AWS Managed Service`                                                                                                                                                             | `Open Source` ( [Amazon MQ](src/DesignComponents/AWS/MessageBrokers/AmazonMQ.md) on AWS ) |
...
## [File Storages on AWS](src/DesignComponents/AWS/FileStorages)

Basis                                 | [S3](src/DesignComponents/AWS/FileStorages/AmazonS3.md)                 | [EFS](src/DesignComponents/AWS/FileStorages/AmazonEFS.md)                    | EBS                                                   |
---------------------------------------|-------------------------------------------------------------------------|------------------------------------------------------------------------------|-------------------------------------------------------|
...
Availability | `99.999999999% durability`, redundancy in at least 3 AZs in S3 Region   | `99.9% availability`, with multiple AZs                                      | `99.999% availability`, with multiple AZs             |
