...
- Service should have [high availability](../../7_SystemGlossaries/Reliability/HighAvailability.md).
...
> Note - `id`, `category_id`, `product_id` columns should be [indexed](../../3_DatabaseServices/Glossaries/DataStructuresDB/Indexing/Readme.md), for faster performance.
