...
This approach can still lead to overloaded partitions, which can be solved using [Consistent Hashing](../../3_DatabaseServices/3_ScalabilityTechniques/PartitioningSharding/Readme.md).
