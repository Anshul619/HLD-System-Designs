...
- It was designed to operate with [predictable low latency at high throughput](../../3_SystemGlossaries/Scalability/LatencyThroughput.md) with uncompromising reliability, both [high availability](../../3_SystemGlossaries/Reliability/HighAvailability.md) and [ACID guarantees](../Glossaries/ACIDTransactions/Readme.md).
