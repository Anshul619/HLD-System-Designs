...
- Spark Streaming supports [highly scalable](../../../3_DatabaseServices/Glossaries/ScalabilityDB.md), [fault-tolerant](../../../7_PropertiesDistributedSystem/Reliability/FaultTolerance.md) continuous stream processing which is mostly used in cases like fraud detection, website monitoring, website click baits, IoT (Internet of Things) sensors, etc.
