...
- In AWS, high availability is achieved through multiple deployments of the app in [different availability zones](../../11_AWSServices/AWS-Global-Architecture-Region-AZ.md).
...
- In AWS, active-passive policy can be configured in the [fail-over routing policy](../../11_AWSServices/1_NetworkingAndContentDelivery/1_EdgeNetworking/AmazonRoute53/Readme.md#failover-routing-policy) in [Route53](../../11_AWSServices/1_NetworkingAndContentDelivery/1_EdgeNetworking/AmazonRoute53/Readme.md).
