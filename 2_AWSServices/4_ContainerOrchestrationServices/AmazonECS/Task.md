...
| [Container Definitions](ContainerDefination.md)                                                                     | [Fargate only](../../3_ComputeServices/AWSFargate.md) | [Docker image](../../../9_ContainerOrchestrationServices/Docker/Readme.md) to use with each container in your task. (Stored/Pulled from [Amazon ECR](../AmazonECR.md))                                                                                                                             |
