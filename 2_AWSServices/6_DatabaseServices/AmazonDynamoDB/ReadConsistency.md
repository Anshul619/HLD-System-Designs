...
- [Eventually consistent](../../../3_DatabaseServices/Consistency&Replication/Readme.md) is the default read consistent model for all read operations.
...
- [Strong Consistency Model](../../../3_DatabaseServices/Consistency&Replication/Readme.md) - When you request a strongly consistent read, DynamoDB returns a response with the most up-to-date data, reflecting the updates from all prior write operations that were successful. 
