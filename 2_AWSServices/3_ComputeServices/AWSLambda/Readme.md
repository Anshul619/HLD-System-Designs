...
- AWS Lambda runs your code on a [high-availability compute infrastructure](../../../7a_HighAvailability/HighAvailability.md) and performs all the administration of compute resources, including server and operating system maintenance, capacity provisioning and automatic scaling, code monitoring and logging. 
