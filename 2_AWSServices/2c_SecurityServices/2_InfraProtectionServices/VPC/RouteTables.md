...
| Destination             | The [range of IP addresses](../../../../7_PropertiesDistributedSystem/Networking/IPAddressRanges.md) where you want traffic to go (destination CIDR). <br/>- For example, an external corporate network with the CIDR 172.16.0.0/12. |
