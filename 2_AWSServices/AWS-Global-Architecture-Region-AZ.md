...
- AZs give customers the ability to operate production applications and databases that are more [highly available](../7_PropertiesDistributedSystem/Reliability/HighAvailability.md), [fault-tolerant](../7_PropertiesDistributedSystem/Reliability/FaultTolerance.md), and [scalable](../3_DatabaseServices/Scalability.md) than would be possible from a single data center.
