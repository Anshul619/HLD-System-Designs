...
| Cold Storage | Object Storage             | [Amazon S3](../2_AWS/7_StorageServices/3_ObjectStorageS3/Readme.md)                                                                      | [Cold storage]() is data that is rarely accessed.<br/>- It can be stored on even slower, `cheap and deep` storage.                                                                                                                                    |
