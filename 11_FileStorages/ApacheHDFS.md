...
- HDFS provides [better data throughput](../7_Scalability/Throughput.md) than traditional file systems, in addition to [high fault tolerance](../7a_HighAvailability/FaultTolerance.md) and native support of large datasets.
