...
| NoSQL Databases          | [Amazon Elastic Cache (Cluster Disabled)](../../2_AWS/1_DatabaseServices/AmazonElasticCache/ClusterMode.md), [Redis - Master Slave Replication](../8_InMemory-Databases/Redis/RedisLeaderFollowReplication.md), MongoDB, DynamoDB etc. |
