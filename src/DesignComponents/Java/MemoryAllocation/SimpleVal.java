...
public class SimpleVal { //The Class (loaded by a classloader) is in the PermGen
    ...
    public SimpleVal(int realValue) {
        value = realValue; // Local variable
    }
    ...
    public static void main(String[] args) {
        ...
        String message = "The output is: "; // IMPORTANT - In Java 7+ the string is created in the heap, in 6 and below it is created in the PermGen
