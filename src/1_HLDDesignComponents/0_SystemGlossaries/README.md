...
- Sharing state with any instances, containers, or functions is possible by using in-memory object caching systems like [Redis](../3_DatabaseComponents/NoSQL-Databases/Redis) or distributed databases like [Cassandra](../3_DatabaseComponents/ApacheCasandra.md) or [Amazon DynamoDB](../../2_AWSComponents/6_DatabaseServices/AmazonDynamoDB.md), depending on the structure of the object and the requirements in terms of performances.
