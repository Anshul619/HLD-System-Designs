...
## Use Leverage Managed Infrastructures like [Amazon S3](../2_AWSComponents/7_StorageServices/AmazonS3/Readme.md), [Amazon Aurora](../2_AWSComponents/6_DatabaseServices/AmazonRDSAurora/Readme.md), [DynamoDB](../2_AWSComponents/6_DatabaseServices/AmazonDynamoDB/Readme.md) etc.
- We should use `Leverage Managed Infrastructures` like [Amazon S3](../2_AWSComponents/7_StorageServices/AmazonS3/Readme.md), [Amazon Aurora](../2_AWSComponents/6_DatabaseServices/AmazonRDSAurora/Readme.md), [DynamoDB](../2_AWSComponents/6_DatabaseServices/AmazonDynamoDB/Readme.md) etc.
