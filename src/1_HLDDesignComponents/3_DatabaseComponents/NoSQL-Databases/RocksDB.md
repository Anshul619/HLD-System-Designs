...
# Introduction
- [RocksDB](http://rocksdb.org/) uses a [log structured database engine](../../0_SystemGlossaries/AppendOnlyDBStorages.md), written entirely in C++, for maximum performance. 
