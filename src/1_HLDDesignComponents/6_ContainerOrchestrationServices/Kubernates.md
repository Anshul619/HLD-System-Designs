...
| [etcd](../7_ClusterCoordinationService/etcd.md)                                                    | etcd is used for [Configuration Store & Service Discovery](../1_MicroServicesSOA/2_ServiceRegistry&Discovery).<br/>- etcd is a [Consistent](../3_DatabaseComponents/1_Glossaries/Replication&Consistency/Consistency.md) and [highly-available key value store](../0_SystemGlossaries/Reliability/HighAvailability.md) used as Kubernetes backing store for all cluster data. |
