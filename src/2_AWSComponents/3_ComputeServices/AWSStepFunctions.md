...
| Use [Amazon S3](../7_StorageServices/3_ObjectStorageTypes/AmazonS3/Readme.md) if payload has the potential to grow beyond the limit for input or output data size   | If your payload has the potential to grow beyond the limit for input or output data size, use [Amazon Simple Storge Service (Amazon S3)](../7_StorageServices/3_ObjectStorageTypes/AmazonS3/Readme.md) to store the data and pass the ARN of the S3 bucket. |
