...
- Save the code in an [S3 bucket](../../7_StorageServices/3_ObjectStorageTypes/AmazonS3/Readme.md), which serves as a repository for the code.
...
## Resources
- The [required Resources section](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/resources-section-structure.html) declares the AWS resources that you want to include in the stack, such as an [Amazon EC2 instance](../../3_ComputeServices/AmazonEC2/Readme.md) or an [Amazon S3 bucket](../../7_StorageServices/3_ObjectStorageTypes/AmazonS3/Readme.md).
...
- For example, you can output the [S3 bucket name](../../7_StorageServices/3_ObjectStorageTypes/AmazonS3/Readme.md) for a stack to make the bucket easier to find. It would then be shown in [Outputs](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/outputs-section-structure.html) section in Cloudformation Stack details page.
