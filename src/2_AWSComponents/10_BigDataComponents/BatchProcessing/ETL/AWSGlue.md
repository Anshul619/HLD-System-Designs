...
- [AWS Glue](https://aws.amazon.com/glue/) is a fully managed [ETL (extract, transform, and load)](../../../../1_HLDDesignComponents/0_SystemGlossaries/BigData/ETL.md) service that makes it simple and cost-effective to categorize your data.
