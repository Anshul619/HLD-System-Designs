...
- EMRFS provides the convenience of storing persistent data in [Amazon S3](../../7_StorageServices/AmazonS3/Readme.md) for use with [Hadoop](../../../1_HLDDesignComponents/5_BigDataComponents/BatchProcessing/ApacheHadoop) while also providing features like data encryption.
