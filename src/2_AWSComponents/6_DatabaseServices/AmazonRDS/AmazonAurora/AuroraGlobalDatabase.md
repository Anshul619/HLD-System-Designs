...
| [Cross-Region Replication with low replica lag (in less than 1 second)](../../../AWS-Global-Architecture-Region-AZ.md) | [Aurora uses physical, log-based asynchronous replication](../../../../1_HLDDesignComponents/3_DatabaseComponents/2_DataStructuresDB/AppendOnlyProperty.md)                                                                                                              |
