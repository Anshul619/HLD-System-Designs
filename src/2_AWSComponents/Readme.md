...
| :star: [Amazon ECS](4_ComputeServices/AmazonECS/Readme.md)                                                                | [Container Orchestration Service](4_ComputeServices)                        | :white_check_mark:                               | :earth_americas: Regional                                                                                                                       | Full Managed [Container Orchestration Service](../1_HLDDesignComponents/0_SystemGlossaries/Scalability/ContainerOrchestrationService.md) (Containers as a service).                                                                                                         |
