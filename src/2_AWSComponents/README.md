...
:star: [Amazon RDS Aurora](6_DatabaseServices/AmazonRDSAurora/Readme.md)                            | [Database Service](6_DatabaseServices)                                              | :white_check_mark:                               | :classical_building: Availability Zone <br/>(Highly Available by default, very less failover time if Multi-AZ enabled) | Database service for Postgres and MySQL ( faster & more reliable than RDS )                                                                                                                                                                                                 |
