        ...
        <td>
            <div class="container" style="background:white">
                ...
                <a href="2_SecurityAndIdentityServices/AWSSecretsManager.md" target="_blank">
                  <img src="https://k21academy.com/wp-content/uploads/2021/03/c-1.png" width="150">
                </a>
            </div>
        </td>
    </tr>
...
----------------------------------------------------------------------------------------------|---------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
 ...
 [AWS Secrets Manager](2_SecurityAndIdentityServices/AWSSecretsManager.md)                               | [Security Service](2_SecurityAndIdentityServices)                         | AWS Secrets Manager helps you manage, retrieve, and rotate database credentials, API keys, and other secrets throughout their lifecycles.                                                                                   |
