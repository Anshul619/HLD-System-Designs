...
:star: [Amazon RDS Aurora](6_DatabaseServices/AmazonRDSAurora/Readme.md)                            | [Database Service](6_DatabaseServices)                                              | :x:                                            | Availability Zone <br/>(Highly Available if Multi-AZ enabled)                     | Fully Managed DB service for Postgres and MySQL ( faster & more reliable than RDS )                                                                                                                                                                                       |
