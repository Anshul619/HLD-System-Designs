...
- [Amazon Aurora vs RDS](6_DatabaseServices/AmazonAuroraVsRDS.md)
...
[Amazon RDS](6_DatabaseServices/AmazonRDS.md)                                                | [Database Service](6_DatabaseServices)                                              | :x:                                            | Availability Zone <br/>(:earth_americas: Regional when Multi-AZ enabled)          | Database management service for relational databases                                                                                                                                                                                                                      |
:star: [Amazon Aurora](6_DatabaseServices/AmazonAurora/Readme.md)                            | [Database Service](6_DatabaseServices)                                              | :x:                                            | Availability Zone <br/>(:earth_americas: Regional when Multi-AZ enabled)          | Fully Managed DB service for Postgres and MySQL ( faster & more reliable than RDS )                                                                                                                                                                                       |
...
[Amazon WorkSpaces](https://aws.amazon.com/workspaces/)                                      | [End User Computing](https://aws.amazon.com/products/end-user-computing/)           | :white_check_mark:                             | Availability Zone                                                                 | Secure, reliable, and scalable access to persistent desktops from any location.                                                                                                                                                                                           |
