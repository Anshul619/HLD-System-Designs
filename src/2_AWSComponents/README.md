...
----------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
 ...
 [AWS Identity Center (successor to AWS SSO)](2_SecurityAndIdentityServices/AWSUsers&AccessMgmt/AWSIAMIdentityCenter.md)                                    | [Security Service](2_SecurityAndIdentityServices)                           | Centrally manage workforce access to multiple AWS accounts and applications.                                                                                                                                                                                                |
 [AWS Organization](2_SecurityAndIdentityServices/AWSUsers&AccessMgmt/AWSOrganization.md)                                    | [Security Service](2_SecurityAndIdentityServices)                           | Centrally manage your environment as you scale your AWS resources.                                                                                                                                                                                                          |
