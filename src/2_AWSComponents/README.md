...
| :star: [Amazon Elastic Load Balancer](1_NetworkingAndContentDelivery/ElasticLoadBalancer/Readme.md)                     | [Networking & Content Delivery Service](1_NetworkingAndContentDelivery)   | :white_check_mark:                             | :earth_americas: Regional <br/> - Internally ELB creates load balancer node in every enabled AZ.<br/> - Atleast 2 AZs should be enabled in ELB. | Fully Managed AWS [Load Balancer Service](../1_HLDDesignComponents/0_SystemGlossaries/LoadBalancer.md)                                                                                                                                                                      |
