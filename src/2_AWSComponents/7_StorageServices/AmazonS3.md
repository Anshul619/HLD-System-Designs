...
- It's distributed and offers a very high level of redundancy ( like [data is stored in 3 AZs within a specific region](../AWS-Global-Architecture-Region-AZ.md) ).
