...
- Step 1: Upload your content to [a static website enabled Amazon S3 bucket](../7_StorageServices/AmazonS3.md) and grant object permissions.
...
- [On a static website, individual webpages include static content](../../1_HLDDesignComponents/0_SystemGlossaries/StaticContentWithCDN.md). 
