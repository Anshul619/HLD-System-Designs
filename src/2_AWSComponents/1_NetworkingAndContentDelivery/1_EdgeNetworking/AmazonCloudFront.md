...
| [Origin Types](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/DownloadDistS3AndCustomOrigins.html)                 | Either [S3](../../7_StorageServices/3_ObjectStorageS3/Readme.md) or Custom Origin (S[3 Website type](../../7_StorageServices/3_ObjectStorageS3/Readme.md), EC2 instance or Lambda function URL etc.).                                                                                                                                                                                                                                                                                             |
