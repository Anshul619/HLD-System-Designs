...
# Archives
- For [disaster recovery](../../1_HLDDesignComponents/0_SystemGlossaries/Reliability/FaultTolerance&DisasterRecovery.md) and auditing purposes event are also set up to be archived. 
