...
| Get historical orders by various conditions.                 | Read       | [OLAP/Analytical](../../1_HLDDesignComponents/5_BigDataComponents/0_Glossaries/DataStorage/DataWarehouses.md) |
| Get order statistics (for example, get the number of orders) | Read       | [OLAP/Analytical](../../1_HLDDesignComponents/5_BigDataComponents/0_Glossaries/DataStorage/DataWarehouses.md) |
