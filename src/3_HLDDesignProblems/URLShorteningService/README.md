...
This approach can still lead to overloaded partitions, which can be solved using [Consistent Hashing](../../1_HLDDesignComponents/0_SystemGlossaries/ConsistentHashing.md).
