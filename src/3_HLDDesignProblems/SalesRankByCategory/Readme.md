...
- SalesRank service would get the sales data from sales table, apply [Map Reduce](../../1_HLDDesignComponents/5_BigDataComponents/ApacheSpark.md) and populate `sales_rank` table. 
