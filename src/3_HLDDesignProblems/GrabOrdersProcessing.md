...
| Get historical orders by various conditions.                 | Read       | [OLAP/Analytical](../1_HLDDesignComponents/5_BigDataComponents/BigData/DataWarehouses.md) |
| Get order statistics (for example, get the number of orders) | Read       | [OLAP/Analytical](../1_HLDDesignComponents/5_BigDataComponents/BigData/DataWarehouses.md) |
...
# Data Stream
- A [Kafka stream](../1_HLDDesignComponents/4_MessageBrokers/Kafka/Readme.md) is used to process data in the data ingestion pipeline. We choose the Kafka stream, because it has 99.95% SLA.
