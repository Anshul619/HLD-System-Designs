...
- Use [Elastic Load Balancing](../../2_AWSComponents/1_NetworkingAndContentDelivery/ElasticLoadBalancer.md) ( with [AWS AutoScaling](../../2_AWSComponents/4_ComputeServices/EC2/AutoScalingGroup/README.md) configured )
