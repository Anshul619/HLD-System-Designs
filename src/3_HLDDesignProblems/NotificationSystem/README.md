...
- Use [Elastic Load Balancing](../../2_AWSComponents/1_NetworkingAndContentDelivery/ApplicationNetworking/ElasticLoadBalancer/Readme.md) ( with [AWS AutoScaling](../../2_AWSComponents/3_ComputeServices/AmazonEC2/AutoScalingGroup/Readme.md) configured )
