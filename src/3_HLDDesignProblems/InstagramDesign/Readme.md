...
| Feature                              | Decision                                                                                                                                               |
|--------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------|
| Images Storage                       | [Amazon S3](../../2_AWSComponents/7_StorageServices/AmazonS3.md) or [HDFS](../../1_HLDDesignComponents/5_BigDataComponents/BatchProcessing/ApacheHadoop/ApacheHDFS.md) |
...
| User Activity - Data Streaming       | [Amazon Kinesis](../../2_AWSComponents/5_MessageBrokerServices/AmazonKinesis/Readme.md)                                                                |
...
| [Amazon Kinesis](../../2_AWSComponents/5_MessageBrokerServices/AmazonKinesis/Readme.md) | Data Streaming                                                                                                                                                                                                                                                                |
