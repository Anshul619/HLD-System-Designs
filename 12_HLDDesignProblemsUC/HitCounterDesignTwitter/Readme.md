...
- [Redis Cache](../../3_DatabaseServices/In-Memory-DB/Redis/Readme.md) (with Cluster enabled).
- [Zookeeper](../../7_ClusterCoordinationServices/ApacheZookeeper.md) for servers coordination.
