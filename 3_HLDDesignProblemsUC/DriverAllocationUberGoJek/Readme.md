...
- Search Cab service would publish message to [Allocate Driver Kafka topic](../../1_HLDDesignComponents/4_MessageBrokers/Kafka/Readme.md).
- Consumer would consume from [Allocate Driver Kafka topic](../../1_HLDDesignComponents/4_MessageBrokers/Kafka/Readme.md).
- [Driver Match Algo](#star-driver-match-algo) to find riders for the given `{rider, pickup, drop}` location msg.
- Match the rider pick location with the corresponding location in [DriverLocation DB (like ElasticSearch/Redis)](../../1_HLDDesignComponents/3_DatabaseComponents/Search-Databases/ElasticSearch/Readme.md).
...
- Push the current location via [Location Kafka topic](../../1_HLDDesignComponents/4_MessageBrokers/Kafka/Readme.md).
- Consumer would consume from [Kafka](../../1_HLDDesignComponents/4_MessageBrokers/Kafka/Readme.md) & then push latest location to [DriverLocation DB (like ElasticSearch/Redis)](../../1_HLDDesignComponents/3_DatabaseComponents/Search-Databases/ElasticSearch/Readme.md).
