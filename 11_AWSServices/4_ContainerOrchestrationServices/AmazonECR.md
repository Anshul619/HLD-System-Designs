...
- Amazon ECR store, manage & deploy [Docker container images](../../6_ContainerOrchestrationServices/Docker/Readme.md).
- ECR is integrated with [ECS](../3_ComputeServices) & [EKS](AmazonEKS.md), simplifying our development to production workflow.
- ECR hosts our images in [highly available](../../0_SystemGlossaries/Reliability/HighAvailability.md) and [scalable architecture](../../0_SystemGlossaries/Scalability).
