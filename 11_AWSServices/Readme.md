...
![img.png](../12_HLDDesignProblemsUC/AWS_DesignMultiRegionActiveActiveArchitecture/AWS-Multi-Region-AZ-HA.drawio.png)

[Read more](../12_HLDDesignProblemsUC/AWS_DesignMultiRegionActiveActiveArchitecture/Readme.md)
...
[Read more](../12_HLDDesignProblemsUC/AWS_ModernDataArchitecture/Readme.md)
...
![](../12_HLDDesignProblemsUC/AWS_DesignUploadImageLambdaS3/UploadImage-Lambda.drawio.png)

[Read more](../12_HLDDesignProblemsUC/AWS_DesignUploadImageLambdaS3/Readme.md)

## Others
- [Send-SMS-API design - App Internal Clients, Multiple SMS-Providers, AutoScaling](../12_HLDDesignProblemsUC/TransactionSMSDesign/Readme.md)
- [WP Site with Amazon CloudFront & S3](../12_HLDDesignProblemsUC/AWSWebsiteSiteUsingCloudFront&S3.md)
- [Dropbox Saves Millions by Building a Scalable Metadata Store on Amazon DynamoDB and Amazon S3](../13_TechStacksRealWorld/Dropbox/DropboxMetaDataStore.md)
