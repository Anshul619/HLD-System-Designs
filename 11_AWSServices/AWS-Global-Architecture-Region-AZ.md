...
- [In AWS, every region would have its own cluster](../0_SystemGlossaries/Scalability/ServersCluster.md).
...
- AZs give customers the ability to operate production applications and databases that are more [highly available](../0_SystemGlossaries/Reliability/HighAvailability.md), [fault-tolerant](../0_SystemGlossaries/Reliability/FaultTolerance.md), and [scalable](../3_DatabaseServices/Glossaries/ScalabilityDB.md) than would be possible from a single data center.
