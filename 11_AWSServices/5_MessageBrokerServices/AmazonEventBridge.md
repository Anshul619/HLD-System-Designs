...
- Using [Amazon EventBridge](), we can build [event-driven applications at scale](../../1_MicroServicesSOA) across AWS, existing systems, or SaaS applications.
...
# Archives
- For [disaster recovery](../../0_SystemGlossaries/Reliability/FaultTolerance.md) and auditing purposes event are also set up to be archived. 
...
# Other Links
- :star: [Amazon EventBridge vs others](../../4_MessageBrokers/KafkaVsRabbitMQVsSQSVsSNS.md)
