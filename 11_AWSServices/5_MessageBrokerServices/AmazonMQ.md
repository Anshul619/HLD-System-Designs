...
# Amazon MQ
- [Amazon MQ](https://aws.amazon.com/amazon-mq) is a managed message broker service for [Apache ActiveMQ](../../4_MessageBrokers/ActiveMQ.md) and [RabbitMQ](../../4_MessageBrokers/RabbitMQ.md) that makes it easy to set up and operate message brokers on AWS.
