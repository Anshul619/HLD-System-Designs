...
- AWS Lambda runs your code on a [high-availability compute infrastructure](../../../0_SystemGlossaries/Reliability/HighAvailability.md) and performs all the administration of compute resources, including server and operating system maintenance, capacity provisioning and automatic scaling, code monitoring and logging. 
...
- [AWS Lambda]() is an example of an [event-driven architecture](../../../1_MicroServicesSOA/EventDrivenArchitecture.md).
